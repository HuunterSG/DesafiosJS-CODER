...
//Ordenando invocadores respecto a su racha de victorias.

var ordenRacha = [];
var ordenRacha = lolArray;
ordenRacha.sort(function(a, b) {
    return a.racha - b.racha
});

console.log('Ordenados por su cantidad de victorias');
console.log(ordenRacha);
document.write("<h3> Lista de Invocadores segun su cantidad de victorias: </h3>");

for (var victoria of ordenRacha) {
    document.write("<ul><li><h3>Nombre de invocador: " + victoria.nickname + " </h3></li>");
    document.write("<li><h3>Linea que juega: " + victoria.linea + " </h3></li>");
    document.write("<li><h3>Campeon preferido: " + victoria.champ + " </h3></li>");
    document.write("<li><h3>Rango de clasificacion: " + victoria.elo + " </h3></li>");
    document.write("<li><h3>Victorias consecutivas: " + victoria.racha + " </h3></li></ul>");
}